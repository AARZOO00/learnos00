  ...
  return (
    <main className="min-h-screen px-6 py-10 md:px-16" style={{ background: 'var(--bg-primary)' }}>
      ...
      <motion.section initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} className="mx-auto max-w-5xl rounded-3xl border border-cyan-400/15 bg-slate-950/70 p-10">
        <LockKeyhole className="mb-6 text-cyan-300" size={42} />
        <h1 className="text-4xl font-bold text-slate-100">Compliance</h1>
        <p className="mt-4 leading-7 text-slate-400">
          LearnOS follows secure authentication, protected routes, and responsible data handling practices.
        </p>
      </motion.section>
    </main>
  )
